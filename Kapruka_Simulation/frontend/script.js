...
async function loadStatistics() {
    try {
        const response = await fetch(`${API_BASE_URL}/api/orders/kapruka/stats/summary`);
...
async function loadOrdersForDisplay(userOrdersMap) {
    try {
        ...
        for (const userId of testUsers) {
            try {
                const response = await fetch(`${API_BASE_URL}/api/orders/kapruka/user/${userId}`);
                const data = await response.json();
...
async function showOrderDetails(orderId) {
    try {
        const response = await fetch(`${API_BASE_URL}/api/orders/kapruka/${orderId}`);
        const data = await response.json();
...
async function createOrder() {
    ...
    try {
        const response = await fetch(`${API_BASE_URL}/api/orders/kapruka`, {
            method: 'POST',
            headers: {
...
async function cancelOrder() {
    ...
    try {
        const response = await fetch(`${API_BASE_URL}/api/orders/kapruka/${selectedOrder.orderId}/cancel`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
