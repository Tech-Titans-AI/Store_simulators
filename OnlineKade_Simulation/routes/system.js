...
router.get('/health', (req, res) => {
  res.json({
    ...
    stores: ['onlinekade', 'kapuruka', 'lassana_flora', 'onlinekade'],
...
router.get('/docs', (req, res) => {
  const apiDocs = {
    ...
    supportedStores: ['onlinekade', 'kapuruka', 'lassana_flora', 'onlinekade'],
    endpoints: {
      onlinekadeOrders: {
      ...
      genericOrders: {
        'POST /api/orders': 'Create a new order (defaults to onlinekade)',
    ...
    storeExamples: {
      onlinekade: {
        url: 'POST /api/orders/onlinekade',
        body: {
          userId: 'user123',
          items: [
            {
